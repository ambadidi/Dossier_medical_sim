...
function ProfileScreen() {
  ...
  const { patient, errorPatient, successPatient } = patientCreate
  ...
  }, [dispatch, navigate, userInfo, user, success]); // Include navigate in dependencies
  ...
  return (
    <Row>
      ...
      <Col md={9}>
        ...
        <Button type="button" className="btn-block" onClick={addPatient} >
          Ajouter
        </Button>
      </Col>
    </Row>
